...
public class FreeVipSeatCondition extends Condition<PartyRegistrationOrder> {
	...
	public Boolean execute(PartyRegistrationOrder input) {
		return input.getLocation().getVipLounge().seats > input.getLocation().getVipPlacementsCount();
	}
